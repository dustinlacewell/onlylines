// Horizontal placer - Simple horizontal lines spanning the canvas

import { registerPlacer } from '../../core/registry';
import { rand, pick } from '../../utils';
import { makeLine } from '../../distributions/utils';

export const horizontal = registerPlacer({
  id: 15,
  name: 'horizontal',
  category: 'grid',
  description: 'Simple horizontal lines spanning the canvas',
